      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <Card className="w-full shadow-2xl border-0 bg-white/90 backdrop-blur-sm">
          <CardHeader className="space-y-1 text-center pt-12">
            <CardTitle className="text-3xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600">Welcome back</CardTitle>
          ...
          <CardContent className="space-y-6 px-8">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl text-center">
              <h3 className="text-lg font-medium text-gray-800 mb-2">One-click sign in</h3>
            ...
            <div className="flex items-center justify-center space-x-2">
              ...
              <span className="text-sm text-gray-400 whitespace-nowrap px-2">New to OpenTree?</span>
              <div className="h-px bg-gray-200 w-full"></div>
            </div>
